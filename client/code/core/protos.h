...
namespace jc::proto
{
	...
	namespace dbg
	{
		...
		{
			using vcall6_obj_init = prototype<int(__thiscall*)(ptr, ptr), 0x7A2210, util::hash::JENKINS("vcall6_obj_init")>;
		...
		using test2	= prototype<int(__stdcall*)(int, int, int, vec3*), 0x9A57EE, util::hash::JENKINS("test2")>;
