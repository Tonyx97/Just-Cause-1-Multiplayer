...
namespace jc::proto
{
	...
	namespace dbg
	{
		...
		{
			using vcall6_obj_init = prototype<void(__thiscall*)(ptr, ptr), 0x6D8E30, util::hash::JENKINS("vcall6_obj_init")>;
			...
			using find_vec3u16    = prototype<bool(__thiscall*)(ptr, uint32_t*, u16vec3*), 0x7A96A0, util::hash::JENKINS("FindVec3u16")>;
			...
			using get_mat4		  = prototype<mat4*(__thiscall*)(ptr, uint32_t*), 0x46B050, util::hash::JENKINS("GetMat4")>;
			
		}

		using test = prototype<void(__thiscall*)(ptr event_instance, int userdata), 0x407FD0, util::hash::JENKINS("test")>;
